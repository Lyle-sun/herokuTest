...
var bootbox = window.bootbox || (function (document, $) {
    ...
    */
    ...
    that.alert = function (/*str,headstr, label, cb*/) {
        var str = "",
            headstr = "",
            label = _translate('OK'),
            cb = null;
    ...
    that.confirm = function (/*str,headstr, labelCancel, labelOk, cb*/) {
        var str = "",
            headstr = "",
    ...
    that.prompt = function (/*str,headstr, labelCancel, labelOk, cb, defaultVal*/) {
        var str = "",
            headstr = "",
            labelCancel = _translate('CANCEL'),
            labelOk = _translate('CONFIRM'),
